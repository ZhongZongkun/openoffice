...
<script>
	$(document).ready(function(){
		...
		$('.show_yiti').click(function(){
				$("#yitilist").html('');
				$("#yitiok").hide();//隐藏添加议题信息中的下一步
				$(".admin_title").html('');
				$("#yitilist").append("<tr class='active'><td>序号</td><td>议题</td><td>提议人</td><td>汇报单位</td><td>汇报人</td><td>列席单位</td><td>列席人</td><td>操作</td></tr>");
				var c=$(this).html();
